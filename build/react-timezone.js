...
var TimezonePicker = function (_React$Component) {
  ...
  _createClass(TimezonePicker, [{
    ...
    value: function filteredTimezones() {
    ...
    value: function handleKeyPress(e) {
      var filteredTimezones = this.filteredTimezones();
      if (e.key === 'ArrowUp' || e.key === 'ArrowDown') {
        ...
        var zone = filteredTimezones[this.state.focused % filteredTimezones.length];
        if (zone) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.filteredTimezones().map(function (zone, index, arr) {
            var focused = _this3.state.focused % arr.length === index;
            return _react2.default.createElement(
              'li',
              {
                key: zone,
                ...
                onMouseDown: function onMouseDown() {
                  return _this3.handleSelect(zone);
                },
                onMouseOver: function onMouseOver() {
                  return _this3.handleItemFocus(index);
                },
                onFocus: function onFocus() {
                  return _this3.handleItemFocus(index);
                },
                className: (0, _classnames2.default)('timezone-picker-list-item', {
...
TimezonePicker.defaultProps = {
  ...
  disabled: false,
  inputProps: {},
  timezones: __webpack_require__(13) // eslint-disable-line global-require
};
